...
public class IODriver {
	 ...
	 * associated with that email If the email is not in the system, it prompts
	 * the user again
	 */
	public void login() {
		...
		/*
		 * while (Objects.isNull(currentUser) ) { response = input.nextLine();
		 * currentUser = storedData.getReturningUser(response); if
		 * (Objects.isNull(currentUser)) { System.out.println(
		 * "Wrong Email...\n Please, try again.\n>"); } }
		 */
